...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("🎥Movies🎥", url="https://t.me/+PDeJI4GPQ95iMGQ1"),
                InlineKeyboardButton("📺Series📺", url="https://t.me/+TFBnRMFWcqM5M2Zl")
            ])
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('🤪Memes Addaa🤪', url='https://t.me/MemesAddaaOfShadow')
            ],
            [
                InlineKeyboardButton('🎬 Movie Adda 🎬', url=f'https://t.me/+9Zhp_GdQVctiNjc1')
            ]
            ]
        ...
        await query.answer('Join @ShadowsArena')
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/ShadowsArena")
    ])
